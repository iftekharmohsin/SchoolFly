          ...
          <div class="navigation container">
            ...
            <div class="myNavbar collapse navbar-collapse">
              <ul class="nav navbar-nav navbar-right">
                ...
                <!-- Item 7-->
                <li class="menu-item"><a data-toggle="dropdown" href="#" class="dropdown-toggle">Signup<i class="fa fa-angle-down"></i></a>
                  <ul class="sub-menu">

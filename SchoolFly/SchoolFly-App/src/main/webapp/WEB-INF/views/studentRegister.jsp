	          ...
	          <!-- Contact Page-->
		          ...
		          <div class="row">
		            ...
		            <div class="col-md-8 contact-form-wrapper">
		              <!-- Contact Form-->
		              <form:form class="contact-form" id='commonSignupModal' action='' method="POST" modelAttribute="parentVo">
		                <div class="field">
		                ...
		                <div class="field">
		                  <form:input type="tel" path="phoneNo" name="phone" placeholder="School"/>
		                </div>
		                <div class="field">
		                  <form:input type="tel" path="phoneNo" name="phone" placeholder="Class"/>
		                </div>
		                <div class="field">
		                  <form:input type="tel" path="phoneNo" name="phone" placeholder="Section"/>
		                </div>
		                <div class="field">
